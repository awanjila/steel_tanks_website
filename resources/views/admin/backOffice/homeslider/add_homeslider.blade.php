                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                          ...
                          <form method="post" action="{{ route('store.slider') }}" enctype="multipart/form-data" id="sliderForm">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="short_title" class="form-control" type="text" id="short-title-input">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="video_url" class="form-control" type="text" id="video-url-input">
