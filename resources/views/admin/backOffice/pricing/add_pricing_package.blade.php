                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('store.pricing.package') }}" enctype="multipart/form-data" id="sliderForm">
                                    @csrf
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Pricing Range</label>
                                        <div class="col-sm-10">
                                            <input name="pricing_range" class="form-control" type="text" id="pricing-input">
                                    ...
                                    <input type="submit" class="btn btn-info waves-effect waves-light" value="Add a Price Package">
                                </form>
                            </div>
                        </div>
                    </div>
