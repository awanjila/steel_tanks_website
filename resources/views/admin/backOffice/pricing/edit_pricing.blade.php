                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('update.pricing') }}" enctype="multipart/form-data" id="sliderForm">
                                    @csrf
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Name</label>
                                        <div class="col-sm-10">
                                            <input name="name" class="form-control" type="text" id="name-input" value="{{$pricing_package->title}}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="pricing" class="form-control" type="text" id="pricing-input" value="{{$pricing_package->pricing}}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="duration" class="form-control" type="text" id="duration-input" value="{{$pricing_package->duration}}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="meta_title" class="form-control" type="text" id="title-input" value="{{$pricing_package->meta_title}}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="description" class="form-control" id="description-input">{{$pricing_package->duration}}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="meta_description" class="form-control" type="text" id="meta-description-input">{{$pricing_package->meta_duration}}</textarea>
                                            <span class="text-danger" id="description-error"></span>
                                        </div>
                                    </div>
                                    <!-- end row -->
